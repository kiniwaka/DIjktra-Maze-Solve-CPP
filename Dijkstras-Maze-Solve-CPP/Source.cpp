//Anthony Lopez's maze and shortest path project shortest path it implemented with Djikstras algorithm
#include"map.h"
#include <iostream>
#include <iomanip>
#include <fstream>  
...
#include "gameMaze.h"
using namespace std;
string* txtToSource(fstream& file, int& k)//reads the map txt file into an array of strings
{
	string temp;
	string* t;
	k = 0;
